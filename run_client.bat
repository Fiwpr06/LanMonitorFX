@echo off
title LanMonitorFX -- May Sinh Vien (Client - AnyDesk Style)

cd /d "%~dp0"

echo ========================================================
echo   LanMonitorFX: Khoi dong May Sinh Vien (Client)
echo ========================================================
echo.
...
echo Dang khoi chay giao dien Sinh vien (AnyDesk Style)...
java -Dfile.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -Dsun.stderr.encoding=UTF-8 --module-path "target\dependency" --add-modules javafx.controls,javafx.fxml,javafx.swing -cp "target\LanMonitorFX-1.0-SNAPSHOT.jar;target\dependency\*" com.fiwpr06.lanmonitorfx.ClientMain
